...
public class LightScript : MonoBehaviour
{
    ...
    private void changeLight()
    {
        ...
        float g = scale((float)bcidata.theta, 0.6f, 1.5f, 0f, 1f);
        float b = scale((float)bcidata.alpha, 0.6f, 1.5f, 0f, 1f);
        float r = scale((float)bcidata.delta, 0.1f, 0.35f, 0f, 1f);

        //Assigning new interpolation values
        c1 = c2;
        c2 = new Color(r, g, b, 1.0f);
        i1 = i2;
        i2 = scale((float)bcidata.betaL, 0f, 2f, 0f, 2.5f);//Scaling intesity value
